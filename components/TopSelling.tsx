import data from '@/data/topSelling.json'
import {
  Card,
...
const TopSelling = () => {
  return (
    <div className='w-full flex flex-col items-center justify-start gap-4'>
          <h1 className='w-full text-center text-3xl font-bold uppercase'>Top Selling</h1>
          <div className='w-full grid grid-cols-4 gap-4 px-16
